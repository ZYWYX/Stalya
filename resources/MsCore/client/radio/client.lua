...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " ne plus afficher.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Pour ~g~allumer~s~ votre radio.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ou ~" .. radioConfig.Controls.Increase.Name .. "~ pour changer de fréquences~n~~" .. radioConfig.Controls.Input.Name .. "~ pour choisir votre fréquences (entrer)~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ Pour ~a~ votre micro en radio ~n~Fréquence: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " ne plus afficher.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Pour ~r~éteindre~s~ votre radio.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ Diffusion.~n~Fréquence: ~1~ MHz" },
...
function Radio:Toggle(toggle)
	...
	if self.Open then
		...
		self.Handle = CreateObject(GetHashKey(self.Prop), 1.0, 1.0, 1.0, 0, 1, 0)
